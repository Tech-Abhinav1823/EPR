...
const AnnouncementsPanel = () => {
  ...
  const announcementsData = [
    ...
    },
    {
      ...
      content: `Due to technical issues with the payment gateway, the hostel fee payment deadline has been extended to 30th September 2024.\n\nStudents can now pay their hostel fees without any late fee charges until the new deadline.`,
      category: "hostel",
      priority: "medium",
    ...
    },
    {
      ...
      isRead: true,
      attachments: [
        { name: "New_Books_List.pdf", size: "180 KB" }
      ]
    },
    {
      id: 4,
      title: "Campus Placement Drive - Tech Companies",
      content: `Major tech companies including TCS, Infosys, and Wipro will be conducting campus placement drives from 1st October 2024.\n\nEligible students must register through the placement portal by 20th September 2024.`,
      category: "placement",
      priority: "high",
    ...
    },
    {
      ...
      content: `Nominations for Student Council Elections 2024 are now open. Students interested in participating can submit their nominations by 18th September 2024.\n\nElections will be held on 25th September 2024.`,
      category: "general",
      priority: "medium",
  ...
  const categories = [
    ...
    { value: 'academic', label: 'Academic', count: announcementsData?.filter(a => a?.category === 'academic')?.length },
    { value: 'hostel', label: 'Hostel', count: announcementsData?.filter(a => a?.category === 'hostel')?.length },
    { value: 'library', label: 'Library', count: announcementsData?.filter(a => a?.category === 'library')?.length },
    { value: 'placement', label: 'Placement', count: announcementsData?.filter(a => a?.category === 'placement')?.length },
    { value: 'general', label: 'General', count: announcementsData?.filter(a => a?.category === 'general')?.length }
  ];

  const filteredAnnouncements = filter === 'all' 
    ? announcementsData 
    : announcementsData?.filter(announcement => announcement?.category === filter);
            ...
            >
              ...
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-start space-x-3 flex-1">
                  <div className="w-8 h-8 bg-muted rounded-lg flex items-center justify-center flex-shrink-0">
                    <Icon name={getCategoryIcon(announcement?.category)} size={16} className="text-muted-foreground" />
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-3 mt-1">
                      ...
                      <span className="text-xs text-muted-foreground">{announcement?.publishDate}</span>
              ...
              <div className="ml-11">
                ...
                {announcement?.attachments?.length > 0 && (
                  <div className="mb-3">
                    <p className="text-xs font-medium text-card-foreground mb-2">Attachments:</p>
